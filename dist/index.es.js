...
function Dr(t) {
  let e, n, r;
  t.length !== 2 ? (e = ue, n = (s, u) => ue(t(s), u), r = (s, u) => t(s) - u) : (e = t === ue || t === eo ? t : no, n = t, r = t);
...
function Mo(t) {
  typeof t == "function" ? t = xo(t) : t = Fr(t);
...
function So(t) {
  return this.select(t == null ? To : Ao(typeof t == "function" ? t : Br(t)));
}
...
function Oo(t) {
  return this.selectAll(t == null ? Po : No(typeof t == "function" ? t : Br(t)));
}
function Io(t) {
...
function Lo(t, e) {
  if (!arguments.length) return Array.from(this, Do);
  var n = e ? Co : Ro, r = this._parents, i = this._groups;
  typeof t != "function" && (t = zo(t));
  for (var o = i.length, a = new Array(o), s = new Array(o), u = new Array(o), l = 0; l < o; ++l) {
    var c = r[l], f = i[l], h = f.length, g = Fo(t.call(c, c && c.__data__, l, r)), d = g.length, p = s[l] = new Array(d), b = a[l] = new Array(d), y = u[l] = new Array(h);
    n(c, f, p, b, y, g, e);
...
function Oa(t, e) {
  var n = typeof t == "function" ? t : Lr(t), r = e == null ? Na : typeof e == "function" ? e : mn(e);
  return this.select(function() {
...
function Xa(t, e) {
  return this.each((typeof e == "function" ? Ga : qa)(t, e));
}
function* Ya() {
  for (var t = this._groups, e = 0, n = t.length; e < n; ++e)
...
const Za = { passive: !1 }, Ft = { capture: !0, passive: !1 };
function Ue(t) {
...
function ns() {
  var t = Qa, e = ja, n = ts, r = es, i = {}, o = yn("start", "drag", "end"), a = 0, s, u, l, c, f = 0;
  function h(_) {
    _.on("mousedown.drag", g).filter(r).on("touchstart.drag", b).on("touchmove.drag", y, Za).on("touchend.drag touchcancel.drag", M).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function g(_, w) {
    if (!(c || !t.call(this, _, w))) {
      var P = A(this, e.call(this, _, w), _, w, "mouse");
      P && (E(_.view).on("mousemove.drag", d, Ft).on("mouseup.drag", p, Ft), Wa(_.view), Ue(_), l = !1, s = _.clientX, u = _.clientY, P("start", _));
    }
  }
  function d(_) {
    if ($t(_), !l) {
  ...
  function b(_, w) {
    if (t.call(this, _, w)) {
      var P = _.changedTouches, N = e.call(this, _, w), O = P.length, q, W;
      for (q = 0; q < O; ++q)
        (W = A(this, N, _, w, P[q].identifier, P[q])) && (Ue(_), W("start", _, P[q]));
    }
  }
  function y(_) {
  ...
  function A(_, w, P, N, O, q) {
    ...
    if ((D = n.call(_, new Qe("beforestart", {
      ...
      return G = D.x - v[0] || 0, I = D.y - v[1] || 0, function Qt(at, ct, bt) {
        var C = v, Be;
        switch (at) {
          case "start":
            i[O] = Qt, Be = a++;
...
var Ht = 0.7, ye = 1 / Ht, At = "\\s*([+-]?\\d+)\\s*", Bt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Y = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", rs = /^#([0-9a-f]{3,8})$/, is = new RegExp(`^rgb\\(${At},${At},${At}\\)$`), os = new RegExp(`^rgb\\(${Y},${Y},${Y}\\)$`), as = new RegExp(`^rgba\\(${At},${At},${At},${Bt}\\)$`), ss = new RegExp(`^rgba\\(${Y},${Y},${Y},${Bt}\\)$`), us = new RegExp(`^hsl\\(${Bt},${Y},${Y}\\)$`), ls = new RegExp(`^hsla\\(${Bt},${Y},${Y},${Bt}\\)$`), Gn = {
  aliceblue: 15792383,
...
function gt(t) {
  var e, n;
  return t = (t + "").trim().toLowerCase(), (e = rs.exec(t)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? Kn(e) : n === 3 ? new k(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? ee(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? ee(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = is.exec(t)) ? new k(e[1], e[2], e[3], 1) : (e = os.exec(t)) ? new k(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = as.exec(t)) ? ee(e[1], e[2], e[3], e[4]) : (e = ss.exec(t)) ? ee(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = us.exec(t)) ? Wn(e[1], e[2] / 100, e[3] / 100, 1) : (e = ls.exec(t)) ? Wn(e[1], e[2] / 100, e[3] / 100, e[4]) : Gn.hasOwnProperty(t) ? Kn(Gn[t]) : t === "transparent" ? new k(NaN, NaN, NaN, 0) : null;
}
function Kn(t) {
...
function je(t, e, n, r) {
  return arguments.length === 1 ? hs(t) : new k(t, e, n, r ?? 1);
}
function k(t, e, n, r) {
...
function ys(t) {
  return (t = +t) == 1 ? Qr : function(e, n) {
    return n - e ? _s(e, n, t) : bn(isNaN(e) ? n : e);
  };
}
function Qr(t, e) {
  var n = e - t;
...
function xn(t, e) {
  var n = typeof e, r;
  return e == null || n === "boolean" ? bn(e) : (n === "number" ? F : n === "string" ? (r = gt(e)) ? (e = r, we) : jr : e instanceof gt ? we : e instanceof Date ? bs : ws(e) ? ms : Array.isArray(e) ? vs : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? xs : F)(t, e);
}
function As(t, e) {
  return t = +t, e = +e, function(n) {
...
var Es = ei(Ts, "px, ", "px)", "deg)"), Ps = ei(Ss, ", ", ")", ")"), Pt = 0, zt = 0, It = 0, ni = 1e3, ve, Rt, be = 0, _t = 0, Te = 0, Ut = typeof performance == "object" && performance.now ? performance : Date, ri = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function Se() {
  return _t || (ri(Ns), _t = Ut.now() + Te);
}
function Ns() {
  _t = 0;
}
...
function nn(t) {
  if (!Pt) {
    ...
    var e = t - _t;
    e > 24 ? (t < 1 / 0 && (zt = setTimeout(jn, t - Ut.now() - Te)), It && (It = clearInterval(It))) : (It || (be = Ut.now(), It = setInterval(Is, ni)), Pt = 1, ri(jn));
  }
}
function tr(t, e, n) {
  var r = new qt();
...
var Rs = yn("start", "end", "cancel", "interrupt"), Cs = [], oi = 0, er = 1, rn = 2, ce = 3, nr = 4, on = 5, fe = 6;
...
function Zs(t, e) {
  ...
  return this.attrTween(t, typeof e == "function" ? (n.local ? Vs : Ks)(n, r, $n(this, "attr." + t, e)) : e == null ? (n.local ? Gs : qs)(n) : (n.local ? Ys : Xs)(n, r, e));
}
function Ws(t, e) {
  return function(n) {
...
function ru(t) {
  var e = this._id;
  return arguments.length ? this.each((typeof t == "function" ? eu : nu)(e, t)) : B(this.node(), e).delay;
}
function iu(t, e) {
  return function() {
...
function au(t) {
  var e = this._id;
  return arguments.length ? this.each((typeof t == "function" ? iu : ou)(e, t)) : B(this.node(), e).duration;
}
function su(t, e) {
  if (typeof e != "function") throw new Error();
  return function() {
...
function uu(t) {
  var e = this._id;
  return arguments.length ? this.each(su(e, t)) : B(this.node(), e).ease;
}
function lu(t, e) {
  return function() {
    var n = e.apply(this, arguments);
...
function gu(t, e) {
  var n = this._id;
  return arguments.length < 2 ? B(this.node(), n).on.on(t) : this.each(pu(n, t, e));
}
function _u(t) {
  return function() {
...
function Tu(t, e, n) {
  var r = (t += "") == "transform" ? Es : ai;
  return e == null ? this.styleTween(t, xu(t, r)).on("end.style." + t, si(t)) : typeof e == "function" ? this.styleTween(t, $u(t, r, $n(this, "style." + t, e))).each(Au(this._id, t)) : this.styleTween(t, Mu(t, r, e), n).on("end.style." + t, null);
}
function Su(t, e, n) {
  return function(r) {
...
function Iu(t) {
  return this.tween("text", typeof t == "function" ? Ou($n(this, "text", t)) : Nu(t == null ? "" : t + ""));
}
function ku(t) {
  return function(e) {
...
function Uu(t) {
  var e, n;
  t instanceof tt ? (e = t._id, t = t._name) : (e = ui(), (n = Hu).time = Se(), t = t == null ? null : t + "");
  for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
    for (var a = r[o], s = a.length, u, l = 0; l < s; ++l)
      (u = a[l]) && Ee(u, t, e, l, a, n || Bu(u, e));
  return new tt(r, this._parents, t, e);
}
Kt.prototype.interrupt = Fs;
Kt.prototype.transition = Uu;
const an = Math.PI, sn = 2 * an, ft = 1e-6, qu = sn - ft;
function li(t) {
  this._ += t[0];
...
class ci {
  constructor(e) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = e == null ? li : Gu(e);
  }
  moveTo(e, n) {
  ...
  arc(e, n, r, i, o, a) {
    ...
    this._x1 === null ? this._append`M${l},${c}` : (Math.abs(this._x1 - l) > ft || Math.abs(this._y1 - c) > ft) && this._append`L${l},${c}`, r && (h < 0 && (h = h % sn + sn), h > qu ? this._append`A${r},${r},0,1,${f},${e - s},${n - u}A${r},${r},0,1,${f},${this._x1 = l},${this._y1 = c}` : h > ft && this._append`A${r},${r},0,${+(h >= an)},${f},${this._x1 = e + r * Math.cos(o)},${this._y1 = n + r * Math.sin(o)}`);
  }
  rect(e, n, r, i) {
...
function Ju(t) {
  var e = t.grouping === void 0 || t.thousands === void 0 ? or : Yu(ar.call(t.grouping, Number), t.thousands + ""), n = t.currency === void 0 ? "" : t.currency[0] + "", r = t.currency === void 0 ? "" : t.currency[1] + "", i = t.decimal === void 0 ? "." : t.decimal + "", o = t.numerals === void 0 ? or : Ku(ar.call(t.numerals, String)), a = t.percent === void 0 ? "%" : t.percent + "", s = t.minus === void 0 ? "−" : t.minus + "", u = t.nan === void 0 ? "NaN" : t.nan + "";
  function l(f) {
    f = Me(f);
    ...
    function W(v) {
      ...
      if (w === "c")
        ...
        v = +v;
        var ct = v < 0 || 1 / v < 0;
        if (v = isNaN(v) ? u : O(Math.abs(v), A), _ && (v = Zu(v)), ct && +v == 0 && d !== "+" && (ct = !1), G = (ct ? d === "(" ? d : s : d === "-" || d === "(" ? "" : d) + G, I = (w === "s" ? sr[8 + fi / 3] : "") + I + (ct && d === "(" ? ")" : ""), q) {
          for (D = -1, Qt = v.length; ++D < Qt; )
            if (at = v.charCodeAt(D), 48 > at || at > 57) {
              I = (at === 46 ? i + v.slice(D + 1) : v.slice(D)) + I, v = v.slice(0, D);
              break;
            }
        }
      }
...
function ll() {
  ...
  function c() {
    ...
    return a !== Mt && (a = ol(t[0], t[h - 1])), s = h > 2 ? sl : al, u = l = null, f;
  }
  function f(h) {
...
function fl(t, e, n, r) {
  ...
  switch (r = Me(r ?? ",f"), r.type) {
    case "s": {
      ...
      return r.precision == null && !isNaN(o = tl(i, a)) && (r.precision = o), hi(r, a);
    }
    case "":
    case "e":
    case "g":
...
Ct.prototype;
var di = typeof global == "object" && global && global.Object === Object && global, dl = typeof self == "object" && self && self.Object === Object && self, rt = di || dl || Function("return this")(), V = rt.Symbol, pi = Object.prototype, pl = pi.hasOwnProperty, gl = pi.toString, kt = V ? V.toStringTag : void 0;
function _l(t) {
  var e = pl.call(t, kt), n = t[kt];
  try {
    t[kt] = void 0;
    var r = !0;
  } catch {
...
var vl = "[object Null]", bl = "[object Undefined]", lr = V ? V.toStringTag : void 0;
function mt(t) {
  return t == null ? t === void 0 ? bl : vl : lr && lr in Object(t) ? _l(t) : wl(t);
}
function lt(t) {
...
function Ne(t) {
  return typeof t == "symbol" || lt(t) && mt(t) == xl;
}
function Zt(t, e) {
...
var R = Array.isArray, cr = V ? V.prototype : void 0, fr = cr ? cr.toString : void 0;
function gi(t) {
  if (typeof t == "string")
    return t;
  if (R(t))
...
var hr = NaN, Sl = /^[-+]0x[0-9a-f]+$/i, El = /^0b[01]+$/i, Pl = /^0o[0-7]+$/i, Nl = parseInt;
function Ol(t) {
  if (typeof t == "number")
    return t;
  if (Ne(t))
  ...
  t = Tl(t);
  var n = El.test(t);
  return n || Pl.test(t) ? Nl(t.slice(2), n ? 2 : 8) : Sl.test(t) ? hr : +t;
}
var dr = 1 / 0, Il = 17976931348623157e292;
function Xe(t) {
  if (!t)
    return t === 0 ? t : 0;
  if (t = Ol(t), t === dr || t === -dr) {
...
var kl = "[object AsyncFunction]", zl = "[object Function]", Rl = "[object GeneratorFunction]", Cl = "[object Proxy]";
function _i(t) {
  if (!et(t))
    return !1;
  var e = mt(t);
  return e == zl || e == Rl || e == kl || e == Cl;
}
var Ye = rt["__core-js_shared__"], pr = (function() {
...
var Ll = Function.prototype, Fl = Ll.toString;
function wt(t) {
  if (t != null) {
    try {
      return Fl.call(t);
...
var Hl = /[\\^$.*+?()[\]{}|]/g, Bl = /^\[object .+?Constructor\]$/, Ul = Function.prototype, ql = Object.prototype, Gl = Ul.toString, Xl = ql.hasOwnProperty, Yl = RegExp(
  "^" + Gl.call(Xl).replace(Hl, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Kl(t) {
  if (!et(t) || Dl(t))
    return !1;
...
function pc(t, e, n) {
  var r = t[e];
  (!(dc.call(t, e) && ke(r, n)) || n === void 0 && !(e in t)) && fc(t, e, n);
}
var gr = Math.max;
function gc(t, e, n) {
...
var mi = Object.prototype, xc = mi.hasOwnProperty, Mc = mi.propertyIsEnumerable, Sn = _r(/* @__PURE__ */ (function() {
  return arguments;
})()) ? _r : function(t) {
  return lt(t) && xc.call(t, "callee") && !Mc.call(t, "callee");
};
function $c() {
  return !1;
}
var wi = typeof exports == "object" && exports && !exports.nodeType && exports, yr = wi && typeof module == "object" && module && !module.nodeType && module, Ac = yr && yr.exports === wi, mr = Ac ? rt.Buffer : void 0, Tc = mr ? mr.isBuffer : void 0, cn = Tc || $c, Sc = "[object Arguments]", Ec = "[object Array]", Pc = "[object Boolean]", Nc = "[object Date]", Oc = "[object Error]", Ic = "[object Function]", kc = "[object Map]", zc = "[object Number]", Rc = "[object Object]", Cc = "[object RegExp]", Dc = "[object Set]", Lc = "[object String]", Fc = "[object WeakMap]", Hc = "[object ArrayBuffer]", Bc = "[object DataView]", Uc = "[object Float32Array]", qc = "[object Float64Array]", Gc = "[object Int8Array]", Xc = "[object Int16Array]", Yc = "[object Int32Array]", Kc = "[object Uint8Array]", Vc = "[object Uint8ClampedArray]", Zc = "[object Uint16Array]", Wc = "[object Uint32Array]", $ = {};
$[Uc] = $[qc] = $[Gc] = $[Xc] = $[Yc] = $[Kc] = $[Vc] = $[Zc] = $[Wc] = !0;
$[Sc] = $[Ec] = $[Hc] = $[Pc] = $[Bc] = $[Nc] = $[Oc] = $[Ic] = $[kc] = $[zc] = $[Rc] = $[Cc] = $[Dc] = $[Lc] = $[Fc] = !1;
function Jc(t) {
...
var vi = typeof exports == "object" && exports && !exports.nodeType && exports, Dt = vi && typeof module == "object" && module && !module.nodeType && module, jc = Dt && Dt.exports === vi, Ke = jc && di.process, wr = (function() {
  try {
    var t = Dt && Dt.require && Dt.require("util").types;
    return t || Ke && Ke.binding && Ke.binding("util");
  } catch {
  }
})(), vr = wr && wr.isTypedArray, bi = vr ? Qc(vr) : Jc, tf = Object.prototype, ef = tf.hasOwnProperty;
function xi(t, e) {
  var n = R(t), r = !n && Sn(t), i = !n && !r && cn(t), o = !n && !r && !i && bi(t), a = n || r || i || o, s = a ? vc(t.length, String) : [], u = s.length;
  for (var l in t)
...
var nf = Mi(Object.keys, Object), rf = Object.prototype, of = rf.hasOwnProperty;
function af(t) {
  if (!yi(t))
    return nf(t);
  var e = [];
...
yt.prototype.clear = pf;
yt.prototype.delete = gf;
yt.prototype.get = wf;
yt.prototype.has = xf;
yt.prototype.set = $f;
function Af() {
...
function Pn(t, e) {
  ...
  return n.cache = new (Pn.Cache || ot)(), n;
}
Pn.Cache = ot;
var Ff = 500;
function Hf(t) {
...
var Bf = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Uf = /\\(\\)?/g, qf = Hf(function(t) {
  var e = [];
  return t.charCodeAt(0) === 46 && e.push(""), t.replace(Bf, function(n, r, i, o) {
    e.push(i ? o.replace(Uf, "$1") : r || n);
  }), e;
});
function Ce(t) {
  return t == null ? "" : gi(t);
...
var Vf = Mi(Object.getPrototypeOf, Object);
function Zf(t, e, n) {
  var r = -1, i = t.length;
...
var Ai = "\\ud800-\\udfff", ah = "\\u0300-\\u036f", sh = "\\ufe20-\\ufe2f", uh = "\\u20d0-\\u20ff", lh = ah + sh + uh, ch = "\\ufe0e\\ufe0f", fh = "[" + Ai + "]", fn = "[" + lh + "]", hn = "\\ud83c[\\udffb-\\udfff]", hh = "(?:" + fn + "|" + hn + ")", Ti = "[^" + Ai + "]", Si = "(?:\\ud83c[\\udde6-\\uddff]){2}", Ei = "[\\ud800-\\udbff][\\udc00-\\udfff]", dh = "\\u200d", Pi = hh + "?", Ni = "[" + ch + "]?", ph = "(?:" + dh + "(?:" + [Ti, Si, Ei].join("|") + ")" + Ni + Pi + ")*", gh = Ni + Pi + ph, _h = "(?:" + [Ti + fn + "?", fn, Si, Ei, fh].join("|") + ")", yh = RegExp(hn + "(?=" + hn + ")|" + _h + gh, "g");
function mh(t) {
  return t.match(yh) || [];
}
function wh(t) {
  return $i(t) ? mh(t) : oh(t);
}
function vh(t) {
  return function(e) {
    e = Ce(e);
    var n = $i(e) ? wh(e) : void 0, r = n ? n[0] : e.charAt(0), i = n ? Wf(n, 1).join("") : e.slice(1);
    return r[t]() + i;
  };
}
...
j.prototype.clear = Mh;
j.prototype.delete = $h;
j.prototype.get = Ah;
j.prototype.has = Th;
j.prototype.set = Eh;
function Ph(t, e) {
...
var Nh = Object.prototype, Oh = Nh.propertyIsEnumerable, xr = Object.getOwnPropertySymbols, Ii = xr ? function(t) {
  return t == null ? [] : (t = Object(t), Ph(xr(t), function(e) {
    return Oh.call(t, e);
  }));
} : Oi, Ih = Object.getOwnPropertySymbols, kh = Ih ? function(t) {
  for (var e = []; t; )
    On(e, Ii(t)), t = Vf(t);
  return e;
} : Oi;
...
var dn = vt(rt, "DataView"), pn = vt(rt, "Promise"), gn = vt(rt, "Set"), $r = "[object Map]", Rh = "[object Object]", Ar = "[object Promise]", Tr = "[object Set]", Sr = "[object WeakMap]", Er = "[object DataView]", Ch = wt(dn), Dh = wt(Xt), Lh = wt(pn), Fh = wt(gn), Hh = wt(ln), Q = mt;
(dn && Q(new dn(new ArrayBuffer(1))) != Er || Xt && Q(new Xt()) != $r || pn && Q(pn.resolve()) != Ar || gn && Q(new gn()) != Tr || ln && Q(new ln()) != Sr) && (Q = function(t) {
  var e = mt(t), n = e == Rh ? t.constructor : void 0, r = n ? wt(n) : "";
  if (r)
    switch (r) {
      case Ch:
        return Er;
...
var Pr = rt.Uint8Array, Bh = "__lodash_hash_undefined__";
function Uh(t) {
...
Yt.prototype.add = Yt.prototype.push = Uh;
Yt.prototype.has = qh;
function Gh(t, e) {
...
function Ri(t, e, n, r, i, o) {
  var a = n & Xh, s = t.length, u = e.length;
  if (s != u && !(a && u > s))
    return !1;
...
var Vh = 1, Zh = 2, Wh = "[object Boolean]", Jh = "[object Date]", Qh = "[object Error]", jh = "[object Map]", td = "[object Number]", ed = "[object RegExp]", nd = "[object Set]", rd = "[object String]", id = "[object Symbol]", od = "[object ArrayBuffer]", ad = "[object DataView]", Nr = V ? V.prototype : void 0, Ve = Nr ? Nr.valueOf : void 0;
...
function fd(t, e, n, r, i, o) {
  var a = n & ud, s = Mr(t), u = s.length, l = Mr(e), c = l.length;
  if (u != c && !a)
    return !1;
  for (var f = u; f--; ) {
    var h = s[f];
...
var hd = 1, Or = "[object Arguments]", Ir = "[object Array]", oe = "[object Object]", dd = Object.prototype, kr = dd.hasOwnProperty;
function pd(t, e, n, r, i, o) {
  var a = R(t), s = R(e), u = a ? Ir : Q(t), l = s ? Ir : Q(e);
  ...
  if (h && !c)
    return o || (o = new j()), a || bi(t) ? Ri(t, e, n, r, i, o) : sd(t, e, u, n, r, i, o);
  if (!(n & hd)) {
  ...
  return h ? (o || (o = new j()), fd(t, e, n, r, i, o)) : !1;
}
function In(t, e, n, r, i) {
  return t === e ? !0 : t == null || e == null || !lt(t) && !lt(e) ? t !== t && e !== e : pd(t, e, n, r, In, i);
}
var gd = 1, _d = 2;
function yd(t, e, n, r) {
  var i = n.length, o = i;
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var c = new j(), f;
      if (!(f === void 0 ? In(l, u, gd | _d, r, c) : f))
        return !1;
    }
  }
  return !0;
...
function bd(t, e) {
  return t != null && Fi(t, e, vd);
}
var xd = 1, Md = 2;
function $d(t, e) {
  return En(t) && Di(e) ? Li(Jt(t), e) : function(n) {
    var r = Gf(n, t);
    return r === void 0 && r === e ? bd(n, t) : In(e, r, xd | Md);
  };
}
function Ad(t) {
  return function(e) {
...
function Hi(t) {
  return typeof t == "function" ? t : t == null ? Oe : typeof t == "object" ? R(t) ? $d(t[0], t[1]) : wd(t) : Sd(t);
}
function Ed(t) {
...
function zd(t, e, n, r) {
  ...
  if (!s)
    return u;
  e.length >= kd && (o = zi, a = !1, e = new Yt(e));
  t:
    for (; ++i < s; ) {
      var c = t[i], f = c;
      if (c = c !== 0 ? c : 0, a && f === f) {
...
var Ld = "[object Map]", Fd = "[object Set]";
function Hd(t) {
  return function(e) {
    var n = Q(e);
    return n == Ld ? Ci(e) : n == Fd ? Dd(e) : Cd(e, t(e));
  };
}
var Ui = Hd(Wt);
function Bd(t, e) {
...
var Ud = Object.prototype, qd = Ud.hasOwnProperty;
function Gd(t, e) {
  return t != null && qd.call(t, e);
}
function qi(t, e) {
  return t != null && Fi(t, e, Gd);
}
function Xd(t, e) {
  return Zt(e, function(n) {
    return t[n];
...
function Yd(t) {
  return t == null ? [] : Xd(t, Wt(t));
}
var Kd = "[object Boolean]";
function Vd(t) {
  return t === !0 || t === !1 || lt(t) && mt(t) == Kd;
}
function Zd(t, e, n, r) {
  if (!et(t))
    return t;
  ...
  for (var i = -1, o = e.length, a = o - 1, s = t; s != null && ++i < o; ) {
    ...
    if (i != a) {
      var c = s[u];
      l = void 0, l === void 0 && (l = et(c) ? c : Ie(e[i + 1]) ? [] : {});
    }
    pc(s, u, l), s = s[u];
  }
  return t;
...
function kn(t, e) {
  if (t == null)
    return {};
  var n = Zt(zh(t), function(r) {
    return [r];
  });
  return e = Hi(e), Wd(t, n, function(r, i) {
    return e(r, i[0]);
  });
}
...
function rp(t) {
  return function(e, n, r) {
    return r && typeof r != "number" && mc(e, n, r) && (n = r = void 0), e = Xe(e), n === void 0 ? (n = e, e = 0) : n = Xe(n), r = r === void 0 ? e < n ? 1 : -1 : Xe(r), np(e, n, r);
  };
}
var Tt = rp();
function ip() {
...
}), Dn = (t) => nt(Ui(t), (e) => e[1]), Ln = (t, e) => he(t, (n, r) => n.widget = e[r]), Fp = (t) => kn(t, (e) => qi(e, "range")), Hp = (t) => kn(t, (e) => Vd(e.default)), Bp = (t) => kn(t, (e) => qi(e, "choices"));
...
function X() {
  ...
  return n = n / 10 + 0.5, n > 1 || n < 0 ? X() : n;
}
const Fn = Fp(x), Hn = Hp(x), Bn = Bp(x);
Cn(Fn);
Cn(Hn);
Cn(Bn);
const Yi = Dn(Fn), Ki = Dn(Hn), Vi = Dn(Bn), de = nt(
  Yi,
  (t) => Op().id(t.id).label(t.label).range(t.range).value(t.default).size(T.widgets.slider_size)
), St = nt(
  Ki,
  (t) => Ip().id(t.id).label(t.label).value(t.default).labelposition(T.widgets.toggle_label_pos)
), pe = nt(
  Vi,
  (t) => kp().choices(t.choices).id(t.id).value(t.default).orientation(T.widgets.radio_orientation).labelposition(T.widgets.radio_label_position)
);
Ln(Yi, de);
Ln(Ki, St);
Ln(Vi, pe);
const ut = Rn().actions(["play", "pause"]), Fe = Rn().actions(["back"]), He = Rn().actions(["rewind"]), Up = [ut, Fe, He], qp = (t, e) => {
  ut.position(
    e.position(
  ...
  t.append("text").attr("x", o.x).attr("y", o.y).attr("class", "static-label").text("Agents:"), t.append("text").attr("x", a.x).attr("y", a.y).attr("class", "static-label").text("Topics:"), t.selectAll(null).data(de).enter().append(ae), t.selectAll(null).data(St).enter().append(ae), t.selectAll(null).data(Up).enter().append(ae), t.selectAll(null).data(pe).enter().append(ae);
}, Gp = (t) => {
...
const Yp = 1e3, Kp = 50, Vp = 25, Zp = [
  ...
  x.timer = {}, x.tick = 0;
  const t = x.number_of_topics.choices[x.number_of_topics.widget.value()], e = x.frame_is_normal.widget.value(), n = 0.05, i = st * (1 - 2 * n) / (t - 1);
  S = nt(Tt(t), (u) => {
    let l;
    e === !1 ? l = Math.random() : l = X();
    let c = st * n + u * i;
    const f = X();
    return {
      index: u,
      ...
      // in seconds
      get max_relevance() {
        return this.network_news_val * this.initial_news_val * Yp;
      },
      get age_relative() {
  ...
  let n;
  e === !1 ? n = Math.random() : n = X(), t.frame = n, t.x = st * n, t.initial_news_val = X(), t.network_news_val = 0, t._incoming_links_count = 0, t.age_absolute = 0;
}, se = (t) => {
  const e = sp(S, t.focussed_topic);
  ...
  let e = [];
  for (const n of S)
    if (n.age_absolute > Kp && n.age_relative > 0.99) {
      Jp(n), e.push(n.index);
      break;
    }
  e.length > 0 && pt.forEach((n) => {
    ...
    const o = (1 - Math.abs(n.culture - r.frame)) * x.weight_alignment.widget.value() + r.network_news_val * x.weight_network_nv + r.initial_news_val * x.weight_inherent_nv - r.age_relative * x.weight_age_punishment, a = x.weight_alignment.widget.value() + x.weight_network_nv + x.weight_inherent_nv, s = x.likelihood_to_switch.widget.value() * a;
    if (n.time_on_topic > Vp) {
      if (o < s) {
        se(n);
        return;
      }
    ...
    if (n.time_on_topic++, n.focussed_topic) {
      const u = S.length, l = st / u, c = n.focussed_topic.y;
      let f;
      X() < 0.5 ? f = c - X() * l : f = c + X() * l, f = Math.max(0, Math.min(st, f)), n.y += (f - n.y) * Xp;
    }
  });
}, jp = "_node_19yup_1", Wi = {
  node: jp
}, Ji = x.L, L = K().domain([0, Ji]), Lt = K().domain([0, Ji]), Qi = 25, t0 = 0, ji = 2, zr = "M0-.415c-.276 0-.5.186-.5.415 0 .118.06.229.166.308l-.08.161c-.004.008-.002.019.005.025a.021.021 0 00.014.005c.004 0 .008-.001.012-.004l.176-.118c.066.025.136.038.209.038.276 0 .5-.186.5-.415S.276-.415 0-.415", e0 = (t, e) => {
  const n = e.display_size.width, r = e.display_size.height;
  L.range([0, n]), Lt.range([0, r]), t.selectAll("#origin").remove();
  const i = t.append("g").attr("id", "origin"), o = L(Qi), a = L(t0), s = L(ji), u = (c) => {
...
const i0 = (t, e) => {
  ...
  He.update(() => Gp(e)), ut.update(() => i0(t)), Fe.update(() => xt(t, n)), x.number_of_agents.widget.update(() => xt(t, n)), x.number_of_topics.widget.update(() => xt(t, n)), St[0].update(() => xt(t, n)), St[1].update(() => xt(t, n));
}, a0 = {
