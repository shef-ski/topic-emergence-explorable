...
function ee(t) {
  if (!Pt) {
    ...
    n > 24
      ...
      : (zt || ((vn = Bt.now()), (zt = setInterval(Ps, ti))), (Pt = 1), ni(je));
  }
}
function tr(t, n, e) {
  var r = new Xt();
...
var zs = ye("start", "end", "cancel", "interrupt"),
  ks = [],
  ri = 0,
  nr = 1,
  re = 2,
...
function gc(t, n, e) {
  if (!nt(e)) return !1;
  var r = typeof n;
  return (r == "number" ? Nt(e) && kn(n, e.length) : r == "string" && n in e)
    ? On(e[n], t)
    : !1;
}
...
function Pe(t, n) {
  if (R(t)) return !1;
  var e = typeof t;
  return e == "number" || e == "symbol" || e == "boolean" || t == null || Nn(t)
    ? !0
...
function Jt(t) {
  if (typeof t == "string" || Nn(t)) return t;
  var n = t + "";
  return n == "0" && 1 / t == -1 / 0 ? "-0" : n;
}
function Ne(t, n) {
...
function zd(t, n, e, r) {
  var i = -1,
    ...
    l = n.length;
  if (!s) return u;
  n.length >= Nd && ((o = ki), (a = !1), (n = new Yt(n)));
  t: for (; ++i < s; ) {
    var c = t[i],
      f = c;
    if (((c = c !== 0 ? c : 0), a && f === f)) {
  ...
  Yp = (t, n) => {
    t
      ...
      t
        ...
        .attr("x1", (e) => N(e.x))
        .attr("y1", (e) => O(e.y))
        .attr("x2", (e) => (e.focussed_topic ? N(e.focussed_topic.x) : N(e.x)))
...
var Ir = {};
const Vp = (t, n) => {
    st.value() == 1 ? (Ir = Ns(() => Kp(t), T.simulation.delay)) : Ir.stop();
  },
  Zp = (t, n, e) => {
    Hn.update(() => Hp(n)),
      st.update(() => Vp(t)),
