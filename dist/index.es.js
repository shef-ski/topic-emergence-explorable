...
function ia(t, n, e) {
    return arguments.length > 1
        ? this.each(
              (n == null ? na : typeof n == "function" ? ra : ea)(
                  t,
                  n,
                  e ?? "",
              ),
...
function Qa() {
    ...
    function g(_, w) {
        if (!(c || !t.call(this, _, w))) {
            ...
            P &&
                (S(_.view)
                    .on("mousemove.drag", d, Lt)
                    .on("mouseup.drag", p, Lt),
                Ya(_.view),
                Bn(_),
                (l = !1),
                (s = _.clientX),
...
function Ms(t) {
    return t == null ||
        (rn ||
            (rn = document.createElementNS("http://www.w3.org/2000/svg", "g")),
...
function ee(t) {
    if (!Pt) {
        ...
        n > 24
            ...
            : (zt || ((vn = Bt.now()), (zt = setInterval(Ps, ti))),
              (Pt = 1),
              ni(je));
    }
}
    ...
    function l(f) {
        ...
        function Z(v) {
            ...
            switch (
                (x &&
                    b &&
                    ((v = n(F + v, F.length ? y - k.length : 1 / 0)), (F = "")),
                g)
            ) {
                case "<":
                    v = G + v + k + F;
...
function fc(t, n, e) {
    var r = t[n];
    (!(cc.call(t, n) && On(r, e)) || (e === void 0 && !(n in t))) &&
        uc(t, n, e);
}
var pr = Math.max;
function hc(t, n, e) {
...
var yi = typeof exports == "object" && exports && !exports.nodeType && exports,
    _r =
        yi && typeof module == "object" && module && !module.nodeType && module,
    xc = _r && _r.exports === yi,
...
var mi = typeof exports == "object" && exports && !exports.nodeType && exports,
    Ft =
        mi && typeof module == "object" && module && !module.nodeType && module,
    Wc = Ft && Ft.exports === mi,
    Kn = Wc && fi.process,
    mr = (function () {
        try {
            ...
            !(
                ...
                (l == "length" || // Node.js 0.10 has enumerable non-index properties on buffers.
                    ...
                    (o &&
                        (l == "buffer" ||
                            l == "byteLength" ||
                            l == "byteOffset")) || // Skip index properties.
                    kn(l, u))
            ) &&
            s.push(l);
    return s;
    ...
    Np = (t, n) => {
        ...
        if (
            ...
            a
                ...
                .attr(
                    "d",
                    ge(t.actions()[t.value()])(t.symbolsize() * t.size()),
                )
                .attr("class", m.symbol),
            r)
        ) {
            ...
            (h =
                t.labelposition().match(/right/i) != null
                    ...
                    : t.labelposition().match(/center/i) != null
                      ...
                      : "start"),
            (g =
                t.labelposition().match(/bottom/i) != null ? "hanging" : "top"),
            s
                .append("text")
...
const Vi = (t, n) => {
    ...
    Up = (t, n) => {
        ...
        i
            ...
            .attr("y1", (a) => O(a.y))
            .attr("x2", (a) =>
                a.focussed_topic ? N(a.focussed_topic.x) : N(a.x),
            )
            .attr("y2", (a) =>
                a.focussed_topic ? O(a.focussed_topic.y) : O(a.y),
            )
            .style("stroke", "#555")
    ...
    Yp = (t, n) => {
        t
            ...
            t
                ...
                .attr("y2", (e) =>
                    e.focussed_topic ? O(e.focussed_topic.y) : O(e.y),
                );
    };
let Or = 0;
function Kp(t, n) {
